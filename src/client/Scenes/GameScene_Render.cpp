...
void GameScene::renderPlayingState()
{
...
/* Render text per-card for points allocated to each card */
void GameScene::renderPopupPointText()
{
...
void GameScene::renderGameOverlays()
{
