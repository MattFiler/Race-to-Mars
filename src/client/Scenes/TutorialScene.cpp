...
void TutorialScene::init()
{
    ...
    //Setup button
    ClickableButton* cont_button = ui_manager.createButton(ui_tutorial_btns::CONTINUE_BUTTON, "UI/TUTORIAL/continue_button.png");
...
game_global_scenes TutorialScene::update(const ASGE::GameTime& game_time)
{
    ...
    Locator::getCursor()->setCursorActive(ui_manager.getButton(ui_tutorial_btns::CONTINUE_BUTTON)->clicked());
    return next_scene;
}
...
void TutorialScene::render()
{
    ...
    Locator::getRenderer()->renderSprite(*ui_manager.getSprite(current_slide)->getSprite());
