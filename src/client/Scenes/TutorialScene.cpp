...
void TutorialScene::init()
{
    ...
    ui_manager.createButton(ui_tutorial_btns::CONTINUE_BUTTON, "UI/TUTORIAL/continue_button.png");
}

/* Handles receiving data from the server */
void TutorialScene::networkDataReceived(const enet_uint8* data, size_t data_size) {}
